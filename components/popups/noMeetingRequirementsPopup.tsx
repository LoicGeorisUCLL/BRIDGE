...
interface noMeetingRequirementsPopupProps {
  show: boolean;
  onClose: () => void;
}

const noMeetingRequirementsPopup: React.FC<noMeetingRequirementsPopupProps> = ({ show, onClose }) => {
      ...
      <div className="relative bg-white rounded-lg p-6 max-w-sm w-full mx-4 text-center">
        ...
        <div className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">
            {t("noMeetingRequirementsTitle")}
          </h3>
          <p className="text-gray-600">
            {t("noMeetingRequirements")}
          </p>
        </div>
...
export default noMeetingRequirementsPopup;